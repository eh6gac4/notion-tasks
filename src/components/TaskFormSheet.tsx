...
export function TaskFormSheet({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col justify-end lg:justify-center lg:items-center lg:p-6">
      ...
      <div
        className="relative rounded-none-2xl px-4 pt-4 pb-[calc(32px+var(--safe-bottom))] max-h-[85svh] overflow-y-auto overscroll-contain lg:rounded-none lg:w-full lg:max-h-[80vh] lg:pb-6 lg:border lg:border-[var(--border-strong)] lg:mx-auto lg:max-w-lg"
        style={{
